...
plotEXCterms_BP_CC_MF <- read.csv("plotEXCterms001_BP_CC_MF.csv", header=FALSE)
...
plotEXCterms_g005_KEEG_REAC_WP <- read.csv("plotEXCterms_g005_KEEG_REAC_WP.csv", header=FALSE)
...
plotEXCterms_g005_BP_CC_MF <- read.csv("plotEXCterms_g005_BP_CC_MF.csv", header=FALSE)
...
plotEXCterms_top3_g005_BP_CC_MF <- read.csv("plotEXCterms_top3_g005_BP_CC_MF.csv", header=FALSE)
